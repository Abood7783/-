...
.room.borderg.hand.nosel.fl.r6vg72jzd9d .fl.u-pic.borderg {
  display: none;
letter-spacing: 1px;
...
.room.borderg.hand.nosel.fl.r6vg72jzd9d .fa.fa-user.label.label-primary.fr.uc {
  letter-spacing: 1px;
...
.room.borderg.hand.nosel.fl.r6vg72jzd9d.bord {border-inline: 4px solid #4c121e !important;}
.room.borderg.hand.nosel.fl.r6vg72jzd9d {
...
.room.borderg.hand.nosel.fl.r6vg72jzd9d .fl.mini.u-msg {
display: none;
  text-align: center;
...
.room.borderg.hand.nosel.fl.r6vg72jzd9d .u-topic.dots {
...
setInterval(function () {
    if (myroom == '6vg72jzd9d') {
        if (r_tiirshlwa == false) {
            r_tiirshlwa = true;
            $('#users').addClass('tiir-shlwa1');
            $('#d2').addClass('tiir-shlwa2');
            $('#mic').addClass('tiir-shlwa3');
        }
    } else {
        if (r_tiirshlwa == true) {
            r_tiirshlwa = false;
            $("#users").removeClass('tiir-shlwa1');
            $("#d2").removeClass('tiir-shlwa2');
            $('#mic').removeClass('tiir-shlwa3');
        } 
    } 
}, 10);
...
.room.borderg.hand.nosel.fl.ri1scui57fs .fl.u-pic.borderg {
  display: none;
letter-spacing: 1px;
  background-size: 108% 108%;
  -webkit-text-fill-color: white;
...
.room.borderg.hand.nosel.fl.ri1scui57fs .fa.fa-user.label.label-primary.fr.uc {
  letter-spacing: 1px;
  -webkit-text-fill-color: #fff;
  background-image: url(https://up6.cc/2025/01/173792471321671.png);
  background-size: 100% 100%;
...
.room.borderg.hand.nosel.fl.ri1scui57fs.bord {border-inline: 4px solid #4c121e !important;}
.room.borderg.hand.nosel.fl.ri1scui57fs {
border-radius: 10px 0px 10px 0px;
display: inline-block;
background-image: linear-gradient(-225deg, rgb(164, 164, 164) 0%, rgba(255, 0, 143, 0) 29%, rgba(151, 101, 127, 0.04) 67%, rgb(189, 189, 189) 100%);
}
.room.borderg.hand.nosel.fl.ri1scui57fs .fl.mini.u-msg {
display: none;
  text-align: center;
  -webkit-text-fill-color: #ffffff70;
  background-image: url(https://up6.cc/2023/01/167382398143361.gif);
...
.room.borderg.hand.nosel.fl.ri1scui57fs {
  border-radius: 5px;
  background-image: url(https://up6.cc/2025/02/173997005109251.png);
...
.room.borderg.hand.nosel.fl.ri1scui57fs .u-topic.dots {
